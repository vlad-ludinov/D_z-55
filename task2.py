...
# вроде как иногда по разному ввыдает, но примерно получается,
# при количестве элементов списка в 30, 40 или 50 раз меньше чем размер
# диапазона значений, скорость работы этих двух сортировок примерно одинаковая,
# при больших значениях, сортировка подсчетом начинает проигрывать,
# ну и логично обратное, при меньшей разнице быстрая сортировка остает 
